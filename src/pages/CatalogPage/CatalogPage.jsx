            ...
            <div className="content">
                ...
                <div className="categories">
                    <div className="categories_btn">
                        <p>Категории:</p>
                        <button onClick={() => setCategory(0)} className="btn">Все товары</button>
                        <button onClick={() => setCategory(1)} className="btn">фрески</button>
                        <button onClick={() => setCategory(2)} className="btn">фотообои</button>
                        <button onClick={() => setCategory(3)} className="btn">жидкие</button>
                    </div>
                ...
                <div className="catalog-items">
                    {
                        sortedFilteredTovars.length ?
                            sortedFilteredTovars.map((tovar) => {
                                return (
                                    <Item id={tovar.id} image={tovar.image} name={tovar.name} color={tovar.color} price={tovar.price} count={tovar.count}/>
                                )
                            })
                            :
